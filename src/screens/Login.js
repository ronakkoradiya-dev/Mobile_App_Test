...
const Login = ({ navigation }) => {
    ...
    const signInHandler = () => {
        if (email != "" && password != "") LoginApiCall()
    ...
    const LoginApiCall = async () => {
        ...
        postServiceCall(ApiList.AUTH_LOGIN, data)
        ...
        <View style={styles.container}>
            ...
            <LinearGradient colors={[Colors.THEME_COLOR, Colors.THEME_SECOND_COLOR]}
                ...
                <View style={styles.userInputContainer} >
                    ...
                    <View style={{ marginTop: sizeWidth(3) }} >
                        <TextInput
                            value={email}
                            onChangeText={(txt) => {
                                setEmail(txt)
                    ...
                    <View style={styles.footerContainer} >
                        <Text style={styles.otherTxt} >{Strings.HAVE_NOT_ACCOUNT}</Text>
                        <Text onPress={() => {
